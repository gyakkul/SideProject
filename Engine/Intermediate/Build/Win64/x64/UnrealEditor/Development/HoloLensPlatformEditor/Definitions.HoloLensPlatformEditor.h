#undef HOLOLENSPLATFORMEDITOR_API
...
#define UE_MODULE_NAME "HoloLensPlatformEditor"
...
#define HOLOLENSTARGETPLATFORM_API DLLIMPORT
#define AUDIOSETTINGSEDITOR_API DLLIMPORT
#define HOLOLENSPLATFORMEDITOR_API DLLEXPORT
