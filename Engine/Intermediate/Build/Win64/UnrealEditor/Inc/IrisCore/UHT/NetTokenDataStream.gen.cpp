...
#include "../Private/Iris/ReplicationSystem/NetTokenDataStream.h"
...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNetTokenDataStream_Statics::Class_MetaDataParams[] = {
...
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UNetTokenDataStream_Statics::StaticCppClassTypeInfo = {
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNetTokenDataStream_Statics::ClassParams = {
		...
		0,
		0x000000A8u,
		METADATA_PARAMS(Z_Construct_UClass_UNetTokenDataStream_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UNetTokenDataStream_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_Iris_Core_Private_Iris_ReplicationSystem_NetTokenDataStream_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNetTokenDataStream, UNetTokenDataStream::StaticClass, TEXT("UNetTokenDataStream"), &Z_Registration_Info_UClass_UNetTokenDataStream, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNetTokenDataStream), 2993126276U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_Iris_Core_Private_Iris_ReplicationSystem_NetTokenDataStream_h_994396810(TEXT("/Script/IrisCore"),
