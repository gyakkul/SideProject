...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMouseWheelInputBehavior_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "BaseBehaviors/MouseWheelBehavior.h" },
		{ "ModuleRelativePath", "Public/BaseBehaviors/MouseWheelBehavior.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UMouseWheelInputBehavior_Statics::StaticCppClassTypeInfo = {
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMouseWheelInputBehavior_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(Z_Construct_UClass_UMouseWheelInputBehavior_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UMouseWheelInputBehavior_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_InteractiveToolsFramework_Public_BaseBehaviors_MouseWheelBehavior_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMouseWheelInputBehavior, UMouseWheelInputBehavior::StaticClass, TEXT("UMouseWheelInputBehavior"), &Z_Registration_Info_UClass_UMouseWheelInputBehavior, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMouseWheelInputBehavior), 2288547999U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_InteractiveToolsFramework_Public_BaseBehaviors_MouseWheelBehavior_h_198212837(TEXT("/Script/InteractiveToolsFramework"),
