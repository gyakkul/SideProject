...
#include "../Private/Tests/MovieSceneDecomposerTests.h"
...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMovieSceneDecomposerTestObject_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "Tests/MovieSceneDecomposerTests.h" },
		{ "ModuleRelativePath", "Private/Tests/MovieSceneDecomposerTests.h" },
	};
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMovieSceneDecomposerTestObject_Statics::NewProp_FloatProperty_MetaData[] = {
		{ "ModuleRelativePath", "Private/Tests/MovieSceneDecomposerTests.h" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMovieSceneDecomposerTestObject_Statics::NewProp_FloatProperty = { "FloatProperty", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UMovieSceneDecomposerTestObject, FloatProperty), METADATA_PARAMS(Z_Construct_UClass_UMovieSceneDecomposerTestObject_Statics::NewProp_FloatProperty_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneDecomposerTestObject_Statics::NewProp_FloatProperty_MetaData)) };
	...
	const FCppClassTypeInfoStatic Z_Construct_UClass_UMovieSceneDecomposerTestObject_Statics::StaticCppClassTypeInfo = {
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneDecomposerTestObject_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UMovieSceneDecomposerTestObject_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneDecomposerTestObject_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Private_Tests_MovieSceneDecomposerTests_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneDecomposerTestObject, UMovieSceneDecomposerTestObject::StaticClass, TEXT("UMovieSceneDecomposerTestObject"), &Z_Registration_Info_UClass_UMovieSceneDecomposerTestObject, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneDecomposerTestObject), 1064816443U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Private_Tests_MovieSceneDecomposerTests_h_1283795407(TEXT("/Script/MovieSceneTracks"),
