...
public: \
	DECLARE_CLASS(UDEPRECATED_PawnAction_Wait, UDEPRECATED_PawnAction, COMPILED_IN_FLAGS(0 | CLASS_Deprecated), CASTCLASS_None, TEXT("/Script/AIModule"), NO_API) \
...
#define FID_Engine_Source_Runtime_AIModule_Classes_Actions_PawnAction_Wait_h_15_STANDARD_CONSTRUCTORS \
	...
	NO_API UDEPRECATED_PawnAction_Wait(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get()); \
	DEFINE_DEFAULT_OBJECT_INITIALIZER_CONSTRUCTOR_CALL(UDEPRECATED_PawnAction_Wait) \
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, UDEPRECATED_PawnAction_Wait); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(UDEPRECATED_PawnAction_Wait); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API UDEPRECATED_PawnAction_Wait(UDEPRECATED_PawnAction_Wait&&); \
	NO_API UDEPRECATED_PawnAction_Wait(const UDEPRECATED_PawnAction_Wait&); \
public: \
	NO_API virtual ~UDEPRECATED_PawnAction_Wait();
