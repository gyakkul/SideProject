...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UAnimationStateGraph);
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimationStateGraph_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "AnimationStateGraph.h" },
		{ "ModuleRelativePath", "Public/AnimationStateGraph.h" },
	};
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimationStateGraph_Statics::NewProp_MyResultNode_MetaData[] = {
		{ "Comment", "// Result node within the state's animation graph\n" },
		{ "ModuleRelativePath", "Public/AnimationStateGraph.h" },
		{ "ToolTip", "Result node within the state's animation graph" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UAnimationStateGraph_Statics::NewProp_MyResultNode = { "MyResultNode", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UAnimationStateGraph, MyResultNode), Z_Construct_UClass_UAnimGraphNode_StateResult_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UAnimationStateGraph_Statics::NewProp_MyResultNode_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimationStateGraph_Statics::NewProp_MyResultNode_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAnimationStateGraph_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(Z_Construct_UClass_UAnimationStateGraph_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimationStateGraph_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_Engine_Source_Editor_AnimGraph_Public_AnimationStateGraph_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Editor_AnimGraph_Public_AnimationStateGraph_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimationStateGraph, UAnimationStateGraph::StaticClass, TEXT("UAnimationStateGraph"), &Z_Registration_Info_UClass_UAnimationStateGraph, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimationStateGraph), 3503331480U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Editor_AnimGraph_Public_AnimationStateGraph_h_1674829502(TEXT("/Script/AnimGraph"),
		Z_CompiledInDeferFile_FID_Engine_Source_Editor_AnimGraph_Public_AnimationStateGraph_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Source_Editor_AnimGraph_Public_AnimationStateGraph_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
