...
#include "../Private/AnimBlueprintExtension_CallFunction.h"
...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UAnimBlueprintExtension_CallFunction);
	UClass* Z_Construct_UClass_UAnimBlueprintExtension_CallFunction_NoRegister()
	{
		return UAnimBlueprintExtension_CallFunction::StaticClass();
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimBlueprintExtension_CallFunction_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "AnimBlueprintExtension_CallFunction.h" },
		{ "ModuleRelativePath", "Private/AnimBlueprintExtension_CallFunction.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UAnimBlueprintExtension_CallFunction_Statics::StaticCppClassTypeInfo = {
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAnimBlueprintExtension_CallFunction_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UAnimBlueprintExtension_CallFunction_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimBlueprintExtension_CallFunction_Statics::Class_MetaDataParams))
	};
	...
	template<> ANIMGRAPH_API UClass* StaticClass<UAnimBlueprintExtension_CallFunction>()
	{
		return UAnimBlueprintExtension_CallFunction::StaticClass();
	}
	...
	DEFINE_VTABLE_PTR_HELPER_CTOR(UAnimBlueprintExtension_CallFunction);
	UAnimBlueprintExtension_CallFunction::~UAnimBlueprintExtension_CallFunction() {}
	struct Z_CompiledInDeferFile_FID_Engine_Source_Editor_AnimGraph_Private_AnimBlueprintExtension_CallFunction_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Editor_AnimGraph_Private_AnimBlueprintExtension_CallFunction_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimBlueprintExtension_CallFunction, UAnimBlueprintExtension_CallFunction::StaticClass, TEXT("UAnimBlueprintExtension_CallFunction"), &Z_Registration_Info_UClass_UAnimBlueprintExtension_CallFunction, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimBlueprintExtension_CallFunction), 1333264137U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Editor_AnimGraph_Private_AnimBlueprintExtension_CallFunction_h_3768146929(TEXT("/Script/AnimGraph"),
		Z_CompiledInDeferFile_FID_Engine_Source_Editor_AnimGraph_Private_AnimBlueprintExtension_CallFunction_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Source_Editor_AnimGraph_Private_AnimBlueprintExtension_CallFunction_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
