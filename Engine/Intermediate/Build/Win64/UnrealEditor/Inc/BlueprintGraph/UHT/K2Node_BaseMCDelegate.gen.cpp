...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UK2Node_BaseMCDelegate);
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_DelegateReference_MetaData[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UK2Node_BaseMCDelegate_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "K2Node_BaseMCDelegate.h" },
		{ "ModuleRelativePath", "Classes/K2Node_BaseMCDelegate.h" },
	};
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UK2Node_BaseMCDelegate_Statics::NewProp_DelegateReference_MetaData[] = {
		{ "Comment", "/** Reference to delegate */" },
		{ "ModuleRelativePath", "Classes/K2Node_BaseMCDelegate.h" },
		{ "ToolTip", "Reference to delegate" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UK2Node_BaseMCDelegate_Statics::NewProp_DelegateReference = { "DelegateReference", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UK2Node_BaseMCDelegate, DelegateReference), Z_Construct_UScriptStruct_FMemberReference, METADATA_PARAMS(Z_Construct_UClass_UK2Node_BaseMCDelegate_Statics::NewProp_DelegateReference_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UK2Node_BaseMCDelegate_Statics::NewProp_DelegateReference_MetaData)) }; // 2112165407
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UK2Node_BaseMCDelegate_Statics::ClassParams = {
		...
		0,
		0x000800A1u,
		METADATA_PARAMS(Z_Construct_UClass_UK2Node_BaseMCDelegate_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UK2Node_BaseMCDelegate_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_Engine_Source_Editor_BlueprintGraph_Classes_K2Node_BaseMCDelegate_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Editor_BlueprintGraph_Classes_K2Node_BaseMCDelegate_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UK2Node_BaseMCDelegate, UK2Node_BaseMCDelegate::StaticClass, TEXT("UK2Node_BaseMCDelegate"), &Z_Registration_Info_UClass_UK2Node_BaseMCDelegate, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UK2Node_BaseMCDelegate), 768730374U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Editor_BlueprintGraph_Classes_K2Node_BaseMCDelegate_h_2761136597(TEXT("/Script/BlueprintGraph"),
		Z_CompiledInDeferFile_FID_Engine_Source_Editor_BlueprintGraph_Classes_K2Node_BaseMCDelegate_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Source_Editor_BlueprintGraph_Classes_K2Node_BaseMCDelegate_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
