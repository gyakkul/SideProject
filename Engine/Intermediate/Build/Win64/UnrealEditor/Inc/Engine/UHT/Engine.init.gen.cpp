...
void EmptyLinkFunctionForGeneratedCodeEngine_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_Engine()
	{
		if (!Z_Registration_Info_UPackage__Script_Engine.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_Engine_HardwareInputDeviceChanged__DelegateSignature,
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_Engine(Z_Construct_UPackage__Script_Engine, TEXT("/Script/Engine"), Z_Registration_Info_UPackage__Script_Engine, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0xF0404764, 0x2986E5B1));
