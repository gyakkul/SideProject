...
#include "../Private/MeshProxyTool/MeshProxyTool.h"
...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UMeshProxySettingsObject);
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMeshProxySettingsObject_Statics::Class_MetaDataParams[] = {
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMeshProxySettingsObject_Statics::NewProp_Settings_MetaData[] = {
		{ "Category", "ProxySettings" },
		{ "ModuleRelativePath", "Private/MeshProxyTool/MeshProxyTool.h" },
		{ "ShowOnlyInnerProperties", "" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMeshProxySettingsObject_Statics::NewProp_Settings = { "Settings", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UMeshProxySettingsObject, Settings), Z_Construct_UScriptStruct_FMeshProxySettings, METADATA_PARAMS(Z_Construct_UClass_UMeshProxySettingsObject_Statics::NewProp_Settings_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMeshProxySettingsObject_Statics::NewProp_Settings_MetaData)) }; // 1902887107
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMeshProxySettingsObject_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UMeshProxySettingsObject_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UMeshProxySettingsObject_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_Engine_Source_Editor_MergeActors_Private_MeshProxyTool_MeshProxyTool_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Editor_MergeActors_Private_MeshProxyTool_MeshProxyTool_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMeshProxySettingsObject, UMeshProxySettingsObject::StaticClass, TEXT("UMeshProxySettingsObject"), &Z_Registration_Info_UClass_UMeshProxySettingsObject, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMeshProxySettingsObject), 2099393903U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Editor_MergeActors_Private_MeshProxyTool_MeshProxyTool_h_3889567459(TEXT("/Script/MergeActors"),
		Z_CompiledInDeferFile_FID_Engine_Source_Editor_MergeActors_Private_MeshProxyTool_MeshProxyTool_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Source_Editor_MergeActors_Private_MeshProxyTool_MeshProxyTool_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
