...
// End Cross Module References
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UBoundarySelectionMechanic_Statics::ClassParams = {
		...
		0,
		0x009000A8u,
		METADATA_PARAMS(Z_Construct_UClass_UBoundarySelectionMechanic_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UBoundarySelectionMechanic_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_ModelingComponents_Public_Selection_BoundarySelectionMechanic_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBoundarySelectionMechanic, UBoundarySelectionMechanic::StaticClass, TEXT("UBoundarySelectionMechanic"), &Z_Registration_Info_UClass_UBoundarySelectionMechanic, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBoundarySelectionMechanic), 1572282778U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_ModelingComponents_Public_Selection_BoundarySelectionMechanic_h_2703719513(TEXT("/Script/ModelingComponents"),
