...
// End Cross Module References
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOptimusComponentBindingProvider_Statics::ClassParams = {
		...
		0,
		0x001040A1u,
		METADATA_PARAMS(Z_Construct_UClass_UOptimusComponentBindingProvider_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusComponentBindingProvider_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Public_IOptimusComponentBindingProvider_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOptimusComponentBindingProvider, UOptimusComponentBindingProvider::StaticClass, TEXT("UOptimusComponentBindingProvider"), &Z_Registration_Info_UClass_UOptimusComponentBindingProvider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusComponentBindingProvider), 524365484U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Public_IOptimusComponentBindingProvider_h_4241683676(TEXT("/Script/OptimusCore"),
