...
// End Cross Module References
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOptimusComputeDataInterface_Statics::ClassParams = {
		...
		0,
		0x001100A1u,
		METADATA_PARAMS(Z_Construct_UClass_UOptimusComputeDataInterface_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusComputeDataInterface_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Public_OptimusComputeDataInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOptimusComputeDataInterface, UOptimusComputeDataInterface::StaticClass, TEXT("UOptimusComputeDataInterface"), &Z_Registration_Info_UClass_UOptimusComputeDataInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusComputeDataInterface), 2824604317U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Public_OptimusComputeDataInterface_h_507163279(TEXT("/Script/OptimusCore"),
