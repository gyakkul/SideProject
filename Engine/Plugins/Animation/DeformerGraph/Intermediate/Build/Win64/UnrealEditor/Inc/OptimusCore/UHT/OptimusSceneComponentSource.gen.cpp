...
// End Cross Module References
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOptimusSceneComponentSource_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UOptimusSceneComponentSource_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusSceneComponentSource_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Private_ComponentSources_OptimusSceneComponentSource_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOptimusSceneComponentSource, UOptimusSceneComponentSource::StaticClass, TEXT("UOptimusSceneComponentSource"), &Z_Registration_Info_UClass_UOptimusSceneComponentSource, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusSceneComponentSource), 1186461232U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Private_ComponentSources_OptimusSceneComponentSource_h_775303338(TEXT("/Script/OptimusCore"),
