...
template<> VCAMCORE_API UScriptStruct* StaticStruct<FVCamWidgetConnectionState>()
{
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FVCamWidgetConnectionState_Statics::NewProp_WidgetConfigs = { "WidgetConfigs", nullptr, (EPropertyFlags)0x0010008000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FVCamWidgetConnectionState, WidgetConfigs), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FVCamWidgetConnectionState_Statics::NewProp_WidgetConfigs_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FVCamWidgetConnectionState_Statics::NewProp_WidgetConfigs_MetaData)) }; // 3632298439
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FVCamWidgetConnectionState_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FVCamWidgetConnectionState_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FVCamWidgetConnectionState_Statics::Struct_MetaDataParams))
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_UI_Switcher_VCamWidgetConnectionState_h_Statics::ScriptStructInfo[] = {
		{ FVCamWidgetConnectionState::StaticStruct, Z_Construct_UScriptStruct_FVCamWidgetConnectionState_Statics::NewStructOps, TEXT("VCamWidgetConnectionState"), &Z_Registration_Info_UScriptStruct_VCamWidgetConnectionState, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FVCamWidgetConnectionState), 1131637468U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_UI_Switcher_VCamWidgetConnectionState_h_1010307334(TEXT("/Script/VCamCore"),
		nullptr, 0,
