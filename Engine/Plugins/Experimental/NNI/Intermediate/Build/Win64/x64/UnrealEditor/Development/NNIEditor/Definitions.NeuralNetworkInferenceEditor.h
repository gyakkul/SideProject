#undef NEURALNETWORKINFERENCEEDITOR_API
...
#define UE_MODULE_NAME "NeuralNetworkInferenceEditor"
...
#define NEURALNETWORKINFERENCEQA_API DLLIMPORT
#define NEURALNETWORKINFERENCEEDITOR_API DLLEXPORT
