...
template<> CHAOSVEHICLES_API UScriptStruct* StaticStruct<FAnimNode_WheelController>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosVehiclesPlugin_Source_ChaosVehicles_Public_AnimNode_WheelController_h_Statics::ScriptStructInfo[] = {
		{ FAnimNode_WheelController::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_WheelController_Statics::NewStructOps, TEXT("AnimNode_WheelController"), &Z_Registration_Info_UScriptStruct_AnimNode_WheelController, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_WheelController), 239075169U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosVehiclesPlugin_Source_ChaosVehicles_Public_AnimNode_WheelController_h_154096134(TEXT("/Script/ChaosVehicles"),
		nullptr, 0,
