#undef ANIMNEXTINTERFACEGRAPHEDITOR_API
...
#define UE_MODULE_NAME "AnimNextInterfaceGraphEditor"
...
#define ANIMNEXTINTERFACE_API DLLIMPORT
#define ANIMNEXTINTERFACEGRAPH_API DLLIMPORT
