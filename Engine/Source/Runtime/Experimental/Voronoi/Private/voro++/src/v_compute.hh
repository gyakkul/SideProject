...
class voro_compute {
	...
	private:
		...
		bool compute_min_max_radius(int di,int dj,int dk,double fx,double fy,double fz,double gx,double gy,double gz,double& crs,double mrs,const typename c_class::radius_info& radi) const;
