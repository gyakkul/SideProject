...
struct wall_sphere : public wall {
	public:
		...
		bool cut_cell(voronoicell &c,double x,double y,double z) const {return cut_cell_base(c,x,y,z);}
		bool cut_cell(voronoicell_neighbor &c,double x,double y,double z) const {return cut_cell_base(c,x,y,z);}
	private:
		const int w_id;
